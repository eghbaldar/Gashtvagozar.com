<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jornaledit.aspx.cs" Inherits="jornaledit" %>
    ...
    <div style="text-align: right">
        <div style="text-align: right">
            ...
            <table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr>
                <td background="images/gashtvagozar-bg-1.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
                  </table>
                      ...
                      <tr>
                        ...
                        <td width="96%"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" height="143">
                            ...
                            <tr>
                              ...
                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="416">
                                  <tr>
                                    <td height="43" colspan="6"><div align="right">
                                    ...
                                    <td width="15%"><asp:Label ID="Label1" runat="server" Text=" : عنوان خبر" Font-Names="Tahoma" Font-Size="10pt"></asp:Label></td>
                                  </tr>
                                  <tr>
                                    <td height="39" colspan="6"><div align="right">
                                  ...
                                  <tr>
                                    <td height="33" colspan="6"><div align="right">
                                      <asp:FileUpload ID="FileUpload1" runat="server" Width="400px" Font-Names="Tahoma" Font-Size="10pt" />
                                    </div></td>
                                    <td><asp:Label ID="Label4" runat="server" Text=" : تصویر خبر" Font-Names="Tahoma" Font-Size="10pt"></asp:Label></td>
                                  </tr>
                                  <tr>
                                    <td height="107" colspan="6"><div align="right">
                                  ...
                                  <tr>
                                    <td height="32" colspan="6"><div align="right">
                                      <asp:Label ID="Label6" runat="server" Width="200px" Font-Names="Tahoma" Font-Size="10pt"></asp:Label>
                                    </div></td>
                ...
                TextMode="MultiLine" Width="590px" Font-Names="Tahoma" Font-Size="10pt" AutoCompleteType="Office"></asp:TextBox>
                                  ...
                                  <tr>
                                    ...
                                    <td width="7%" style="height: 2px"><asp:CheckBox ID="CheckBox5" runat="server" Text="اقتصادی" Font-Names="Tahoma" /></td>
                                    <td width="7%" style="height: 2px"><asp:CheckBox ID="CheckBox1" runat="server" Text="اجتماعی" Font-Names="Tahoma" /></td>
                                    <td width="9%" style="height: 2px"><asp:CheckBox ID="CheckBox2" runat="server" Text="فرهنگی و هنری" Font-Names="Tahoma" /></td>
                                    <td width="7%" style="height: 2px"><asp:CheckBox ID="CheckBox3" runat="server" Text="جهانگردی" Font-Names="Tahoma" /></td>
                                    <td style="width: 7%; height: 2px"><asp:CheckBox ID="CheckBox4" runat="server" Text="ایرانگردی" Font-Names="Tahoma" /></td>
                                    <td style="height: 2px">&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td height="74" colspan="6"><div align="right">
                                      <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="بازگشت" Width="70px" Font-Names="Tahoma" CausesValidation="False" />
                                      
                                      <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="تغییرات" Width="70px" Font-Names="Tahoma" />
